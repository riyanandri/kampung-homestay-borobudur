            ...
            <div class="bee-row-content">
                ...
                <div class="bee-col bee-col-2 bee-col-w5">
                    ...
                    <div class="bee-block bee-block-2 bee-heading">
                        <h1
                            style="color:#B56952;direction:ltr;font-family:'Roboto Slab', Arial, 'Helvetica Neue', Helvetica, sans-serif;font-size:74px;font-weight:700;letter-spacing:normal;line-height:120%;text-align:left;margin-top:0;margin-bottom:0;">
                            Kampung Homestay Borobudur<br /> </h1>
                    </div>
                </div>
            ...
            <div class="bee-row-content">
                ...
                <div class="bee-col bee-col-2 bee-col-w8">
                    <div class="bee-block bee-block-1 bee-paragraph">
                        <p><strong>Halo {{ $booking['name'] }}!</strong><br /><strong>Pesanan kamar anda telah
                                dikonfirmasi.</strong></p>

                        <h4> Check In : {{ $booking['check_in'] }}</h4>
                        <h4> Check Out : {{ $booking['check_out'] }}</h4>
                        <h4> Username : {{ $booking['name'] }}</h4>
                        <h4> Email : {{ $booking['email'] }}</h4>
                        <h4> No Hp : {{ $booking['phone'] }}</h4>

                        <p>Terima kasih telah mengunjungi homestay kami.</p>
                    </div>
                    <div class="bee-block bee-block-2 bee-button"><a class="bee-button-content"
                            href="https://kampunghomestayborobudur.site"
                            ...
                            target="_self"><span dir="ltr"
                                style="word-break: break-word; font-size: 14px; line-height: 200%; letter-spacing: 1px;">Beranda</span></a>
                    </div>
                </div>
                    ...
                    <div class="bee-block bee-block-2 bee-text">
                        <div class="bee-text-content"
                            ...
                            <p style="line-height: 18px; text-align: center;"><span
                                    style="line-height: 18px;">kampunghomestay@gmail.com </span></p>
                ...
                <div class="bee-col bee-col-1 bee-col-w12">
                    <div class="bee-block bee-block-1 bee-text">
                        <div class="bee-text-content"
                            ...
                            <p style="font-size: 14px; line-height: 16px; text-align: center;"><span
                                    style="font-size: 12px; line-height: 14px;">2023 KampungHomestayBorobudur © All
