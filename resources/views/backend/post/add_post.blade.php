...
@section('admin')
    ...
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">Tambah Artikel</div>
            <div class="ps-3">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body p-4">
                                <form class="row g-3" action="{{ route('store.blog.post') }}" method="post"
                                    enctype="multipart/form-data">
                                    @csrf
                                    <div class="col-md-6">
                                        <label for="input7" class="form-label">Kategori Blog</label>
                                    ...
                                    <div class="col-md-6">
                                        <label for="input1" class="form-label">Judul Artikel</label>
                                        <input type="text" name="post_title" class="form-control" id="input1">
                                    </div>

                                    <div class="col-md-12">
                                        <label for="input11" class="form-label">Deskripsi Singkat</label>
                                        <textarea name="short_desc" class="form-control" id="input11" rows="3"></textarea>
                                    </div>

                                    <div class="col-md-12">
                                        <label for="input11" class="form-label">Deskripsi Artikel</label>
                                        <textarea name="long_desc" class="form-control" id="myeditorinstance"></textarea>
                                    </div>

                                    <div class="col-md-6">
                                        <label for="input1" class="form-label">Gambar</label>
